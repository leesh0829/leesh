...
/**
 * Extracts level 1–6 headings from a Markdown string into TOC entries.
 *
 * Ignores headings inside fenced code blocks, normalizes heading text, and generates unique slug IDs (appending `-N` for duplicate slugs).
 *
 * @param markdown - The raw Markdown source to scan for headings
 * @returns An array of `TocHeading` objects containing each heading's `id`, display `text`, and `level`
 */
