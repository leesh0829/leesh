...
/**
 * Parse a Response body as JSON and return null if parsing fails.
 *
 * @param res - The Fetch API Response whose body should be parsed as JSON
 * @returns The parsed JSON value, or `null` if the response body is not valid JSON or parsing fails
 */
