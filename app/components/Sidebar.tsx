...
/**
 * Render the application's responsive sidebar including navigation, account controls,
 * daily cards, a mini-game promo, and an updates modal.
 *
 * @param open - Whether the mobile sidebar is currently visible
 * @param onClose - Callback invoked to close the sidebar (used for mobile navigation and links)
 * @param desktopOpen - Whether the desktop sidebar is expanded and interactive
 * @param onToggleDesktop - Callback invoked to toggle the desktop sidebar open/closed
