...
/**
 * Render a GitHub SVG icon.
 *
 * @param className - Optional CSS class names applied to the root `<svg>` element (default: `'h-4 w-4'`)
 * @returns The GitHub SVG as a JSX element
 */
...
/**
 * Render the Leesh portfolio page including read-only or editable markdown content, an unlock/login modal, and a contact form.
 *
 * @returns The React element representing the Leesh portfolio page.
 */
